...
<head>
 <body> <button oneclick = "aboutUs()"> <p1> aboutUs ℹ️</p1> </button> </body>
    ...
    <title>www.eyob_Chemistry/quiz.com</title>
    <style>
        body {
...
<h1>CHEMISTRY GENERAL KNOWLEDGE QUIZ⏱️</h1>
<div id="quiz"></div>
<button onclick="checkAnswers()"> Checke Answer</button> <h1> look the explanation and answer down there ⬇️ </h1>
<div id="result"></div>
